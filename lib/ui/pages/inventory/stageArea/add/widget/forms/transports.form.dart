...
class TransportsForm extends StatefulWidget {
  @override
  _TransportsFormState createState() => _TransportsFormState();
}

class _TransportsFormState extends State<TransportsForm> {
            ...
            children: [
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: commonInputDecoration(context: context, labelText: "Nome do Transporte"),
                  style: TextStyle(
                    fontSize: 20,
