...
class InventoryAppsCard extends StatelessWidget {
  final dynamic pathIcon;
  final String name;
  final String stageArea;

  InventoryAppsCard({@required this.pathIcon, @required this.name, @required this.stageArea});
  ...
  Widget build(BuildContext context) {
    ...
    localLink() {
      ...
      g.global = true;
      g.setStageArea(value: stageArea, setRoute: "inventory/$stageArea");
