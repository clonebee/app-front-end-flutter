...
class ManufactureAppsCard extends StatelessWidget {
  final dynamic pathIcon;
  final String name;
  final String stageArea;

  ManufactureAppsCard({@required this.pathIcon, @required this.name, @required this.stageArea});
  ...
  Widget build(BuildContext context) {
    ...
    localLink() {
      ...
      g.global = true;
      g.setStageArea(value: stageArea, setRoute: "manufacture/$stageArea");
