...
class IndicatorsAppsCard extends StatelessWidget {
  dynamic pathIcon;
  String name;
  String stageArea;

  IndicatorsAppsCard({@required this.pathIcon, @required this.name, @required this.stageArea});
  ...
  Widget build(BuildContext context) {
    ...
    localLink() {
      ...
      g.global = true;
      g.setStageArea(value: stageArea, setRoute: "indicators/$stageArea");
