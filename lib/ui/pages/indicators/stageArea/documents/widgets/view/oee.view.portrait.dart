...
class OeeViewPortrait extends StatefulWidget {
  const OeeViewPortrait({Key key}) : super(key: key);

  @override
  _OeeViewPortraitState createState() => _OeeViewPortraitState();
}

class _OeeViewPortraitState extends State<OeeViewPortrait> {
  bool init = true;
